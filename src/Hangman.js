  ...
  render() {
    return (
      <div className='Hangman'>
        ...
        <p className='Hangman-btns'>{this.state.nWrong !== this.props.maxWrong ? this.generateButtons() : <p>YOU LOSE</p>}</p>
        {this.guessedWord().join('') === this.state.answer && <p>YOU WIN!</p>}
        <div className='Hangam'>
          <button onClick={this.restart} id='reset'>RESTART GAME</button>
        </div>
      </div>
